...
_Build the complete user journey with basic functionality_
...
_Core data that other features depend on_
...
_Raid scheduling and signup system_
...
_Record and manage loot distribution_
...
_Forums, announcements, knowledge base_
...
_Recruitment and public presence_
